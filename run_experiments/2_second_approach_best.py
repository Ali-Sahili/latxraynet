...
res_path = "results/specialized_basic_model_best"
...
model = SpecializedBasicModel(model_name = "resnet50", 
                                state_dict=state_dict,
                                    apply_freeze=True)

train_model(model, train_loader, val_loader, device, pos_weight=pos_weight,
        epochs=N_EPOCHS, 
        model_name="specialized_basic_model_frozen_backbone_resnet50",
        res_path=res_path)